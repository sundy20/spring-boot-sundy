...
/**
 * @author plus.wang
 * @description 基于StringRedisTemplate redis基础操作组件
 * @date 2018/5/14
 */
@Component
public class RedisComponent {
     ...
     * @param date
     */
    public Boolean expireKeyAtDate(String key, Date date) {
     ...
     * @param dbIndex
     */
    public Boolean moveKey(String key, int dbIndex) {
     ...
     * @param increment
     */
    public Long hashIncrByLong(String key, Object field, long increment) {
     ...
     * @param delta
     */
    public Double hashIncrByFloat(String key, Object field, double delta) {
     ...
     * @param unit    时间单位
     */
    public String listBlockLeftPop(String key, long timeout, TimeUnit unit) {
     ...
     * @param unit    时间单位
     */
    public String listBlockRightPop(String key, long timeout, TimeUnit unit) {
     ...
     * @param unit
     */
    public String listBlockRightPopAndLeftPush(String sourceKey, String destinationKey, long timeout, TimeUnit unit) {
    ...
    /**
     * 返回元素在集合倒置后的排名,按元素的score值由大到小排列
     *
     * @param key
     * @param value
     */
     ...
     * @param end
     */
    public Set<TypedTuple<String>> zsetRangeWithScores(String key, long start, long end) {
     ...
     * @param max 最大值
     */
    public Set<TypedTuple<String>> zsetRangeByScoreWithScores(String key, double min, double max) {
     ...
     * @param end
     */
    public Set<TypedTuple<String>> zsetRangeByScoreWithScores(String key, double min, double max, long start, long end) {
     ...
     * @param end
     */
    public Set<TypedTuple<String>> zsetReverseRangeWithScores(String key, long start, long end) {
     ...
     * @param max
     */
    public Set<TypedTuple<String>> zsetReverseRangeByScoreWithScores(String key, double min, double max) {
